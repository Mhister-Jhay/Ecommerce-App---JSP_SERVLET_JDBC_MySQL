<%@ page import="com.example.week6ecommerce.model.Order" %>
...
<head>
    <meta charset="utf-8">
    <title>Jhay Commerce | orders</title>
    ...
    <div class="row px-xl-5">
        <div class="col-12">
            <nav class="breadcrumb align-items-center bg-light mb-30">
                <a href="orders"><h5 class="font-weight-semi-bold m-0">My Orders</h5></a>
            </nav>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    <div class="row px-xl-5">
        <div class="col-lg-8 table-responsive mb-5">
            <table class="table table-light table-borderless table-hover text-center mb-0">
                ...
                <tr>
                    ...
                    <td class="align-middle"><%=order.getPrice()*order.getQuantity()%></td>
                    <td class="align-middle"><%=order.getDate()%></td>
                </tr>
                <%}%>
                </tbody>
            </table>
        ...
        <div class="col-lg-4">
            <h5 class="section-title position-relative text-uppercase mb-3" style="color: black"><span class="bg-secondary pr-3">Order Summary</span></h5>
