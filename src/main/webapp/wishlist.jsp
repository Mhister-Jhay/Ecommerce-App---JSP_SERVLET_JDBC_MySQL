...
<head>
    <meta charset="utf-8">
    <title>Jhay Commerce | wishlist</title>
...
<div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4" style="color: black"><span class="bg-secondary pr-3">My WishList</span></h2>
    <div class="row px-xl-5">
        <div class="container-fluid">
            <div class="row px-xl-5">
                <div class="col-12">
                    <nav class="breadcrumb align-items-center bg-light mb-30">
                        <h5 class="font-weight-semi-bold m-0">Saved Products</h5>
                    </nav>
                </div>
            </div>
        </div>
