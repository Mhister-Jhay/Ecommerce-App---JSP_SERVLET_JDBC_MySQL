                    ...
                    <div class="carousel-item position-relative active" style="height: 430px;">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                ...
                                <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Get the best of all Grocery products from Perishable, Canned and Packaged varieties</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item position-relative" style="height: 430px;">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                ...
                                <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Get the best of Fashion for Men, Women, and Children</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item position-relative" style="height: 430px;">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                ...
                                <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Get the best of all Electronic and Mobile devices, very affordable</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4">
            <div class="product-offer mb-30" style="height: 200px;">
                ...
                <div class="offer-text">
                    <h6 class="text-white text-uppercase">valid till July,2023</h6>
                    <h3 class="text-white mb-3">20% Off Groceries</h3>
                </div>
            </div>
            <div class="product-offer mb-30" style="height: 200px;">
                ...
                <div class="offer-text">
                    <h6 class="text-white text-uppercase">valid till July,2023</h6>
                    <h3 class="text-white mb-3">13% Discount on Laptops</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-4 col-md-6 pb-1">
            <a class="text-decoration-none" href="">
                <div class="cat-item img-zoom d-flex align-items-center mb-4">
                    ...
                    <div class="flex-fill pl-3">
                        <h6>Fashion</h6>
                        <small class="text-body">6 Products</small>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-lg-4 col-md-6 pb-1">
            <a class="text-decoration-none" href="">
                <div class="cat-item img-zoom d-flex align-items-center mb-4">
                    ...
                    <div class="flex-fill pl-3">
                        <h6>Electronics and Mobile</h6>
                        <small class="text-body">7 Products</small>
                    </div>
                </div>
            </a>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a href="wishlist.jsp" class="text-secondary mb-2">
                            <i class="fa fa-angle-right mr-2">Wishlist</i>
                        </a>
                        <a href="orders.jsp" class="text-secondary mb-2">
                            <i class="fa fa-angle-right mr-2">Orders</i>
                        </a>
                    </div>
                </div>
                <div class="col-md-4 mb-5">
